...
from mark2mind.chains.reformat_text_chain import ReformatTextChain
...
class ReformatTextStage:
    ...
    def __init__(self,
                 ...
                 retryer: Retryer,
                 callbacks=None,
                 chain_instance: ReformatTextChain | None = None):
    ...
    def _make_chain(self):
        ...
        return ReformatTextChain(llm, callbacks=self.callbacks)
    ...
    def run(self,
        ...
        def process(item: Tuple[int, str]) -> Dict:
            ...
            formatted = self.retryer.call(local_chain.invoke, text, config={"meta": f"reformat:{idx}"})
        ...
        setattr(ctx, "reformat_outputs", outputs_sorted)
        return ctx
